            ...
            <>
                <footer>
                    ...
                    <div className={styles.f_contenedor}>
                        ...
                        <div className={styles.f_contenido}>
                            <p className={styles.f_texto}>¡Hablanos! Queremos saber de tí.</p>
                            <p className={styles.f_texto}>Horario de atencion: 00:00 - 00:00</p>
                        </div>
                        </div>
                        ...
                        <div className={styles.f_contenido}>
                            <p className={styles.f_texto}>¡Envíos por Starken a todo chile! </p>
                                </div>
                             </div>
                        </div>
                    </div>
